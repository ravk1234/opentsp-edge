...
def main() -> None:
    ...
    print(f"Total tiled micro-ops: {int8.total_tiled_events}")
    print(f"Total tiled cycles: {int8.total_tiled_cycles}")
    ...
    print("\nDeterministic INT8 decoder integration check: PASSED")
